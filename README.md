...
$$
 \begin{aligned}
  i\hbar\frac{d\psi_X}{dt}(\textbf{r}, t) &= \big(E_X(\textbf{k}) + V_X(\textbf{r}) + \hbar g_X (\psi_X|\psi_X(\textbf{r}, t)|^2 + n_r(\textbf{r}, t)) + \hbar\Omega_R\psi_C(\textbf{r}, t) - i\hbar\frac{\gamma_X+\gamma_{inc}}{2}\psi_X(\textbf{r}, t) \\
  i\hbar\frac{d\psi_C}{dt}(\textbf{r}, t) &= \big(E_C(\textbf{k}) + V_C(\textbf{r}) + \hbar\Omega_R\psi_X(\textbf{r}, t) - i\hbar\frac{\gamma_C+\gamma_{inc}}{2}\psi_C(\textbf{r}, t) + \hbar F(\textbf{r},t) \\
