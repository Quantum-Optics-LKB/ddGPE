...
gamma_exc, gamma_cav = 0.0015 /h_bar, 0.07 / 0.6571 / h_bar # (meV/h_bar) exc and ph linewidth 1microeV 69microeV  original value 0.07/h_bar
...
# Target reservoir/coherent LP blueshift ratio at steady state and k=0.
beta = 0.49
delta_cx = omega_cav - omega_exc
X02 = 0.5 * (1 + delta_cx / (delta_cx**2 + 4 * rabi**2)**0.5)
gamma_res = beta * X02 * gamma_exc # (1/ps) coherent-to-reservoir feeding rate
